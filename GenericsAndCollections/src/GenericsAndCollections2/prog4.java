...
public class prog4 {
    public static void main(String[] args) {
        ...
        studentList.add(new Student("Pak", 19, 97.5));
        studentList.add(new Student("Sunaina", 40, 76.0));
        studentList.add(new Student("Anushka", 14, 78.5));
        ...
        Student student1 = new Student("Maya", 23, 75.6);
        Student student2 = new Student("Maya", 23, 75.6);
 ...
 * Name: Pak, Age: 19, Mark: 97.5
 * Name: Sunaina, Age: 40, Mark: 76.0
 * Name: Anushka , Age: 14, Mark: 78.5
