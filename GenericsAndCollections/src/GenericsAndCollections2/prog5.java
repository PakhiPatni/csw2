...
public class prog5 {
    public static void main(String[] args) {
        ...
        Book book1 = new Book(128, "Fault in our stars", "Ana hong", 3);
        Book book2 = new Book(129, "November", "Collin Hover", 7);
        library.addBook(1, book1);
        library.addBook(2, book2);
        library.displayBooks();
        String searchBookName = "Reco";
 ...
 *
 * Library Books:
 * ID: 1, Book [id=128, name=Fault in our stars, author=Ana hong, quantity=3]
 * ID: 2, Book [id=129, name=November, author=Collin Hover, quantity=7]
 * The book 'Reco' is present in the library.
