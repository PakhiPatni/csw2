...
public class prog7 {
    public static void main(String[] args) {
        ...
        tree.root.left = new TreeNode2(70);
        tree.root.right = new TreeNode2(40);
        tree.root.left.left = new TreeNode2(30);
        tree.root.left.right = new TreeNode2(70);
        tree.root.right.left = new TreeNode2(60);
        tree.root.right.right = new TreeNode2(20);
